...
module.exports = class Video extends BaseProvider {
  ...
  constructor(
    ...
    Logger.info("Video with username", username, "created");
...
this._getLogMetadata());
  ...
  async _recordViaWebRTCRecorder (sourceMediaId, recordingPath, username, {
    filename,
    carbonCopy = false,
  }) {

    Logger.debug("_recordViaWebRTCRecorder username", username);
